...
import { ChevronLeftIcon, CameraIcon, QrCodeIcon } from "react-native-heroicons/outline";
    ...
    return (
        <View style={tw`flex-1 bg-blue-600  content-between`}>
            ...
            <View>
                ...
                <View style={tw`mt-21`}>
                    {status ? (
                        <View style={tw`bg-white mx-3 h-[90%] rounded-3xl p-2 flex justify-center items-center`}>
                            <QRCodeScanner style={tw``}
                                onRead={({ data }) => { setData(data); setStatus(false) }}
                                ...
                                topContent={
                                    <View>
                                        <Text style={tw`text-white p-5 m-2`}>Please move your camera {"\n"} over the QR Code</Text>
                                    </View>
                                }
                                bottomContent={
                                    <View>
                        ...
                        <View style={tw`bg-white mx-3 h-[90%] rounded-3xl p-2 flex justify-around items-center content-around`}>
                            <View style={tw`flex items-center`}>
                                <CameraIcon style={tw`text-blue-500`} />
                                <Text style={tw`text-center text-blue-800`}>Please move your camera {'\n'} over the QR Code</Text>
                            </View>
                            <QrCodeIcon style={tw`text-blue-300 `} size={200} />
                            <TouchableOpacity onPress={() => { setStatus(true); setData('') }} style={tw`border p-2 rounded-lg border-blue-400`}>
                                <View style={tw`flex-row `}><CameraIcon style={tw`text-blue-500`} />

                                    <View style={tw`flex justify-center `}>

                                        <Text style={tw`text-blue-500 `} >  Scan QR Code</Text></View>
                                </View>
                            </TouchableOpacity>
                        </View>
                    )}
