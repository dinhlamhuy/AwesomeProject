        ...
        <SafeAreaView style={tw`flex-1  bg-blue-600`} >
            <View style={tw`flex-1 flex justify-around my-4`}>
                ...
                <View style={tw`flex-row justify-center`}>
                    <Image source={require("../../assets/image/welcome.png")} style={tw`text-center`} />
                </View>
                <View style={tw`space-y-4`}>
                    <TouchableOpacity onPress={()=> navigation.navigate('Signup')} style={tw`py-2 bg-yellow-400 mx-9 rounded-xl`}>
